...
function BookCarousel({ title = "¿Quieres más libros?", limit = 20 }) {
  ...
  const settings = {
    ...
    infinite: true,
    speed: 300,
    slidesToShow: 3, // Puedes ajustar este número según tus necesidades
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 3000,
    arrows: true,
      ...
      <Slider {...settings}>
        {libros.map((libro) => (
          <div key={libro.id_libro} className="slick-slide">
            <Card className="fade-in featured-card">
